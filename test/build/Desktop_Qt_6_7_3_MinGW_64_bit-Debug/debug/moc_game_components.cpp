/****************************************************************************
** Meta object code from reading C++ file 'game_components.h'
**
...
#error "The header file 'game_components.h' doesn't include <QObject>."
...
void Ball::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Ball::*)();
            if (_t _q_method = &Ball::gameOver; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void GameManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->handleGameOver(); break;
        default: ;
        }
    }
    (void)_a;
