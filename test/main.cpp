...
int main(int argc, char* argv[]) {
    ...
    QPushButton* playButton = new QPushButton("\u904a\u73a9", &mainMenu);
    QPushButton* exitButton = new QPushButton("\u96e2\u958b", &mainMenu);
    ...
    mainMenu.setWindowTitle("\u4e3b\u9078\u55ae");
    mainMenu.setFixedSize(300, 200);
    mainMenu.show();
